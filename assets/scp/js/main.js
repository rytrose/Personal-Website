...
function animation(){
  ...
  function init() {
    ...
    preload([
        '/scp/Facebook Reaction PNGs/like.png',
        '/scp/Facebook Reaction PNGs/love.png',
        '/scp/Facebook Reaction PNGs/sad.png',
        '/scp/Facebook Reaction PNGs/angry.png',
        '/scp/Facebook Reaction PNGs/haha.png',
        '/scp/Facebook Reaction PNGs/wow.png'
    ]);
    ...
    image.addEventListener( 'load', function ( event ) {
      ...
      for ( var i = 0; i < reactions.length; i ++ ) {
        ...
        if(reactions[i] == "LIKE")
          sprite.src = '/scp/Facebook Reaction PNGs/like.png';
        if(reactions[i] == "LOVE")
          sprite.src = '/scp/Facebook Reaction PNGs/love.png';
        if(reactions[i] == "SAD")
          sprite.src = '/scp/Facebook Reaction PNGs/sad.png';
        if(reactions[i] == "ANGRY")
          sprite.src = '/scp/Facebook Reaction PNGs/angry.png';
        if(reactions[i] == "HAHA")
          sprite.src = '/scp/Facebook Reaction PNGs/haha.png';
        if(reactions[i] == "WOW")
          sprite.src = '/scp/Facebook Reaction PNGs/wow.png';
    ...
    image.src = '/scp/Facebook Reaction PNGs/like.png';
  ...
  var highlight = function () {
    ...
    if(reactions[highlightFlag] == "LIKE")
      img.src = '/scp/Facebook Reaction PNGs/like1.png';
    if(reactions[highlightFlag] == "LOVE")
      img.src = '/scp/Facebook Reaction PNGs/love1.png';
    if(reactions[highlightFlag] == "SAD")
      img.src = '/scp/Facebook Reaction PNGs/sad1.png';
    if(reactions[highlightFlag] == "ANGRY")
      img.src = '/scp/Facebook Reaction PNGs/angry1.png';
    if(reactions[highlightFlag] == "HAHA")
      img.src = '/scp/Facebook Reaction PNGs/haha1.png';
    if(reactions[highlightFlag] == "WOW")
      img.src = '/scp/Facebook Reaction PNGs/wow1.png';
